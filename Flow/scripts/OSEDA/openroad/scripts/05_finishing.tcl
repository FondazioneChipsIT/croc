...
extract_parasitics -ext_model_file ${pdk_dir}/ihp-sg13g2/libs.tech/librelane/IHP_rcx_patterns.rules
write_spef ${out_dir}/${proj_name}.spef
write_abstract_lef -bloat_factor 3 ${out_dir}/${proj_name}.lef
write_timing_model -corner tt ${out_dir}/${proj_name}.lib
write_sdf -corner tt ${out_dir}/${proj_name}.sdf
...
utl::report "#  - SPEF:        ${out_dir}/${proj_name}.spef"
utl::report "#  - LEF:         ${out_dir}/${proj_name}.lef"
utl::report "#  - LIB:         ${out_dir}/${proj_name}.lib"
